...
MODELS = [
    ("customcnn_depth2",  (32, 64), "/models/customcnn_depth2/customcnn_depth2_final.pth"),
    ("customcnn_depth3",  (32, 64, 128), "/models/customcnn_depth3/customcnn_depth3_final.pth"),
    ("customcnn_depth4",  (32, 64, 128, 256), "/models/customcnn_depth4/customcnn_depth4_final.pth"),
    ("customcnn_depth5_v1", (32, 64, 128, 256, 256), "/models/customcnn_depth5_v1/customcnn_depth5_v1_final.pth"),
    ("customcnn_depth5_v2", (32, 64, 128, 256, 512), "/models/customcnn_depth5_v2/customcnn_depth5_v2_final.pth"),
]
...
def print_table(rows):
    headers = ["Model", "Depth", "mAP@50", "mAP@50:95", "FPS", "Params(M)", "MACs(G)"]
